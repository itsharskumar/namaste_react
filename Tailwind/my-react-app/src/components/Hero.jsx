const Hero = () => {
  return (
    <section className="min-h-screen bg-black text-white flex items-center justify-center relative overflow-hidden">
      ...
      {/* Gradient orbs */}
      <div className="absolute top-20 left-20 w-72 h-72 bg-indigo-600 rounded-full blur-3xl opacity-20 animate-pulse"></div>
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-purple-600 rounded-full blur-3xl opacity-20 animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-slate-500 mb-12 max-w-xl mx-auto">
          I create beautiful, performant web applications with modern technologies.
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#projects"
            className="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-full font-medium transition-all hover:scale-105 shadow-lg shadow-indigo-500/50"
          >
            View My Work
          </a>
          <a
            href="#contact"
            className="px-8 py-3 bg-transparent border border-slate-600 hover:bg-slate-800 rounded-full font-medium transition-all hover:scale-105"
          >
            Get In Touch
          </a>
        </div>
